...
RESULTS_PATHS = {
    "curia": {
        "internal": Path("foundation_model_curia/predictions_test_internal.csv"),
        "external": Path("foundation_model_curia/predictions_test_external.csv"),
    },
    "medimage": {
        "internal": Path("foundation_model_medimageinsight/predictions_test_internal.csv"),
        "external": Path("foundation_model_medimageinsight/predictions_test_external.csv"),
    },
    "biomed": {
        "internal": Path("foundation_model_biomedclip/predictions_test_internal.csv"),
        "external": Path("foundation_model_biomedclip/predictions_test_external.csv"),
    },
    "morpho": {
        "internal": Path("morphology/predictions_test_internal.csv"),
        "external": Path("morphology/predictions_test_external.csv"),
    },
    "radiomics": {
        "internal": Path("radiomics/predictions_test_internal.csv"),
        "external": Path("radiomics/predictions_test_external.csv"),
    },
    "lsn": {
        "internal": Path("radiologist_assisted/predictions_test_internal.csv"),
        "external": Path("radiologist_assisted/predictions_test_external.csv"),
    },
    "serum_clinical": {
        "internal": Path("serum/predictions_test_internal.csv"),
        "external": Path("serum/predictions_test_external.csv"),
    },
}
...
def main(base_path: Path, output_dir: Path, significance_level: float, threshold: float):
    ...
    # BiomedCLIP and MedImageInsight are reported in a separate comparison and are left out of the
    # pairwise test; uncomment them (here and in the permutation lists below) to include them.
